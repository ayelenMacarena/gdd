...
{
    public partial class ListadoXFacturas : Form
    {
        String inicio;
        String fin;
     
        public ListadoXFacturas(String año, String trimestre)
        {
            InitializeComponent();
            label1.Text = año;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                SqlCommand cmd = new SqlCommand("select * from LA_PETER_MACHINE.topDeVendedoresPorFacturas(@fechaInicio,@fechaFin)");
